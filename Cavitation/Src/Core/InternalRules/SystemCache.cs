...
// {
//     public class SystemRules : RulesModel
//     {
//         private static readonly string Appdata = GetEnvironmentVar("Appdata");
//         private static readonly string SystemRoot = GetEnvironmentVar("SystemRoot");
//
//
//         public SystemRules() : base(
