...
public partial class RegistryManagerPage : Page
{
    ...
    private void Panel_OnInitialized(object sender, EventArgs e)
    {
        ...
        AddItem("隐藏登录背景毛玻璃特效", "",Registry.LocalMachine,@"SOFTWARE\Policies\Microsoft\Windows\System","DisableAcrylicBackgroundOnLogon",1,0);
        AddItem("电源图标", "",Registry.LocalMachine,@"SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System","shutdownwithoutlogon",1,0);
        AddItem("任务栏亚克力透明", "",Registry.LocalMachine,@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced","UseOLEDTaskbarTransparency",1,0);
    }

    private void AddItem(string name, string description, RegistryKey root, string path, string key, object enabledValue, object disabledValue) =>
