...
public partial class AdjustmentPage
{
    ...
    {
        {
            MessageBox.Show("from https://github.com/99natmar99/Windows-11-Fixer","temporarily closed",MessageBoxButton.OK,MessageBoxImage.Information);
            MessageBox.Show("I will do a complete refactoring","temporarily closed",MessageBoxButton.OK,MessageBoxImage.Information);
            MessageBox.Show("This feature is not yet implemented.","temporarily closed",MessageBoxButton.OK,MessageBoxImage.Information);
            return;
        }
        ...
        if (Notifications_Disable.IsChecked == true)
        {
            ...
            var restartService = new ProcessStartInfo("powershell.exe");
        ...
        {
            Registry.SetValue("HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\UserProfileEngagement",
        ...
        {
            Registry.SetValue("HKEY_CURRENT_USER\\Software\\Microsoft\\Clipboard", "EnableClipboardHistory", "00000001",
                RegistryValueKind.DWord);
        }
        else if (Clipboard_Disable.IsChecked == true)
        {
            Registry.SetValue("HKEY_CURRENT_USER\\Software\\Microsoft\\Clipboard", "EnableClipboardHistory", "00000000",
                RegistryValueKind.DWord);
        }
    ...
    private void UN_Priv_Click(object sender, RoutedEventArgs e) => SelectRecPriv.IsChecked = false;

    private void UN_AppPerm_Click(object sender, RoutedEventArgs e) => SelectRecAppPerm.IsChecked = false;
}